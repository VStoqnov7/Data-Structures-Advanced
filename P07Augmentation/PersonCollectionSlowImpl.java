...
//        List<P07Augmentation.Person> result = this.getPeopleByPredicate(person -> person.getEmail().equals(email));
...
//                .sorted(Comparator.comparing(P07Augmentation.Person::getEmail))
